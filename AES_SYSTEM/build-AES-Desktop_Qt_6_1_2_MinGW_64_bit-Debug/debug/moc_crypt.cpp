...
const QMetaObject Crypt::staticMetaObject = { {
    ...
    qt_meta_stringdata_Crypt.offsetsAndSize,
    qt_meta_data_Crypt,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Crypt_t
